/**
 * RPG Artale - 資料庫與數值平衡檔 (v22 - Final Specification)
...
const JOB_MAPLE = {
    ...
    "皇家騎士團": { 
        "核心": { 
            ...
            4: ["聖魂劍士", "烈焰巫師(四)", "破風使者(四)", "暗夜行者(四)", "閃雷悍將(四)"] 
        } 
    },
    "超越者": { "超越者": { 1: "神之子" } },
    "朋友世界": { "超能力": { 1: "凱內西斯" } }
...
// 助手升級費用：每級成長 1.15 倍，受轉職階級倍率影響 (Cost Scaling)
function getHelperCost(lv, tierMult = 1) { 
    return 10 * tierMult * Math.pow(1.15, lv - 1); 
}

// 助手傷害：每級成長 1.16 倍，受轉職階級倍率影響 (Dmg Scaling)
function getHelperDmg(lv, tierMult = 1) { 
